...
function CodeMirror({ code, editorTheme, onCodeChange, mHidden }: Props) {
  ...
  return (
    <div
      className={cn("overflow-x-scroll overflow-y-scroll lg:mx-4 border-[4px] border-black app-code-css", mHidden ? "m-hidden" : "")}
      ref={ref}
    />
  );
}
